...
class MainViewController: UIViewController {
    ...
    static let MERCHANT_ID = "m7jcaqrflstmfkk0kgpt"             // Generated in Openpay account registration
    static let API_KEY = "pk_9a0beaf6bd004bfcbd70df4d9b8cd931"  // Generated in Openpay account registration
